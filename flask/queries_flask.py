...
QUERY_PERCENTILE = """
SELECT query_id, count_L90, count_U90,
  avgTime_L90, minTime_L90, maxTime_L90, 
  avgHits_L90, minHits_L90, maxHits_L90,
  avgTime_U90, (avgTime_U90 / avgTime_L90) as avgTimeRatio, minTime_U90, maxTime_U90, 
  avgHits_U90, (avgHits_U90 / avgHits_L90) as avgHitsRatio, minHits_U90, maxHits_U90
FROM
(
